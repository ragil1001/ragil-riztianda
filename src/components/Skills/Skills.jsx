...
const Skills = () => {
  return (
    <section id="skills" className="border-y border-black/10 bg-[#edf0f4]">
      <div className="mx-auto max-w-[1400px] px-5 py-24 sm:px-8 lg:px-12 lg:py-28">
        <div className="max-w-[760px]">
          ...
          <p className="mt-5 max-w-[620px] text-lg leading-8 text-[#626872]">
        ...
        <div className="mt-14 grid border-t border-black/10 md:grid-cols-2 xl:grid-cols-4">
          {SkillsInfo.map((category, index) => (
            ...
            >
              <p className="text-sm font-semibold text-[#2055ff]">{category.title}</p>
              <ul className="mt-6 space-y-3">
                {category.skills.map((skill) => (
                  <li key={skill} className="text-[15px] leading-6 text-[#505761]">
                    {skill}
                  </li>
                ))}
              </ul>
